        ...
        <SkeletonTheme>
            <section className="py-10 font-sans">
                ...
                <main className="mt-16 m-auto max-w-3xl">
                    <section className="mt-5 md:mt-10 mb-10">
                        <div className="font-bold mx-auto text-center space-y-8" id="startMessage">
                        ...
                        <section>
                            {searchResults
                                ? searchResults?.meanings.map((meaning, index) => (
                                      <article key={index} className={index !== 0 ? "py-10" : null}>
